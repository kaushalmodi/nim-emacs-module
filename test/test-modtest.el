...
(ert-deftest modtest-sum ()
  ...
  (unless (functionp 'modtest-sum-no-nim-assert)
    (defalias 'modtest-sum-no-nim-assert 'modtest-sum))
  (should-error (modtest-sum-no-nim-assert "1" 2) :type 'wrong-type-argument)
  (should-error (modtest-sum-no-nim-assert 2 "1") :type 'wrong-type-argument)
  (should-error (modtest-sum-no-nim-assert 2.0 1.0) :type 'wrong-type-argument))
